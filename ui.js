...
function toggleLoading(isLoading) {
  if (isLoading) {
    document.querySelector("#IconToChng").removeAttribute("class");
    document
      .querySelector("#IconToChng")
      .setAttribute("class", "fas fa-hourglass-half");
    document.querySelector("#txt").innerHTML = "Loading...";
  } else {
    document
      .querySelector("#IconToChng")
      .setAttribute("class", "fas fa-search");
    document.querySelector("#txt").innerHTML = "Search";
  }
}
